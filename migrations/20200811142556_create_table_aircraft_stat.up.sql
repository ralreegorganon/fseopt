...
insert into aircraft_stat (make_model, cost_per_nm, cruise, max_pax, cargo_25, cargo_100, padding_minutes, query) values ('Cessna Citation X', 1.8, 450, 10, 5257, 1347, 0, true);
